...
namespace ThreadSafeList.Tests
{
    ...
    {
        public static void VerifyTwoEnumeratorsOnSameThread(ThreadSafeList<int> valTypes, ThreadSafeList<string> refTypes)
        {
            ...
            IEnumerator<int> v1 = valTypes.GetEnumerator();
            v1.MoveNext();
            IEnumerator<int> v2 = valTypes.GetEnumerator();
            v2.MoveNext();
            ...
            // object, we should not get a LockRecursionException (i.e.
            // we should be able to enumerate via different enumerators)
            IEnumerator<object> r1 = refTypes.GetEnumerator();
            r1.MoveNext();
            IEnumerator<object> r2 = refTypes.GetEnumerator();
            r2.MoveNext();
    ...
    [TestClass()]
    public class SnapshotThreadSafeListTests
    {
        /// <summary>
        ...
        [TestMethod()]
        public void SnapshotThreadSafeListTest()
        {
        ...
        [TestMethod()]
        public void SnapshotThreadSafeListTest1()
        {
        ...
        [TestMethod()]
        public void SnapshotThreadSafeListTest2()
        {
    ...
    [TestClass()]
    public class ThreadSafeObjectThreadSafeListTests
    {
        /// <summary>
        /// Random number generator for obtaining random numbers
        /// </summary>
        ...
        List<int> valueTypes;
        List<string> referenceTypes;
        ThreadSafeObjectThreadSafeList<int> valueTypesThreadSafeList;
        ThreadSafeObjectThreadSafeList<string> referenceTypesThreadSafeList;
        ...
        public void BeforeEachTest()
        {
            ...
            valueTypesThreadSafeList = new ThreadSafeObjectThreadSafeList<int>(valueTypes);
            referenceTypesThreadSafeList = new ThreadSafeObjectThreadSafeList<string>(referenceTypes);
        }
        ...
        [TestMethod()]
        public void ThreadSafeObjectThreadSafeListTest()
        {
            Assert.IsNotNull(new ThreadSafeObjectThreadSafeList<int>());
            Assert.IsNotNull(new ThreadSafeObjectThreadSafeList<object>());
        }

        [TestMethod()]
        public void ThreadSafeObjectThreadSafeListTest1()
        {
            Assert.IsNotNull(new ThreadSafeObjectThreadSafeList<int>(20));
            Assert.IsNotNull(new ThreadSafeObjectThreadSafeList<object>(20));
        }

        [TestMethod()]
        public void ThreadSafeObjectThreadSafeListTest2()
        {
            Assert.IsNotNull(valueTypesThreadSafeList);
            Assert.IsTrue(valueTypesThreadSafeList.SequenceEqual(valueTypes));
            Assert.AreEqual(valueTypesThreadSafeList.Count, valueTypes.Count());
        ...
        public void GetEnumeratorTest()
        {
            TestMethods.VerifyTwoEnumeratorsOnSameThread(valueTypesThreadSafeList, referenceTypesThreadSafeList);
        }
